...
public class MokoSupport implements MokoResponseCallback {
    ...
    private HashMap<Integer,Boolean> mStepsMap;

    public void initStepsListInterval() {
        if (mSteps != null) {
            mSteps.clear();
        } else {
    ...
    public void setStepsMap(HashMap<Integer,Boolean> stepsMap) {
        this.mStepsMap = stepsMap;
    }
    ...
    ///////////////////////////////////////////////////////////////////////////
    // Step interval, Cam-implemented
    ///////////////////////////////////////////////////////////////////////////
    private int mStepInterval;

    public int getStepInterval(){return mStepInterval;}
