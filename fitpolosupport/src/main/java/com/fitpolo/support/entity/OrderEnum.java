...
public enum OrderEnum implements Serializable {
    ...
    //Step Interval addition
    Z_READ_STEP_INTERVAL("Get the current step interval",0x20),
    Z_WRITE_STEP_INTERVAL("Set the step interval", 0x21),

    Z_READ_RECENT_STEPS("Read step intervals",0x05),
    ;
